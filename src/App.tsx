      ...
      {!isAuthPage &&<Header></Header>}
        <AnimatePresence mode="wait">
            <Routes location={location} key={location.pathname}>
                ...
                <Route path='MenuDetaile/:menuid/:menutype' element={<ProtectedRoute><motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.5 }}><Menudetaile></Menudetaile></motion.div></ProtectedRoute>}></Route>
                <Route path='moremenu/MenuDetaile/:menuid/:menutype' element={<ProtectedRoute><motion.div initial={{opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.5 }}><Menudetaile></Menudetaile></motion.div></ProtectedRoute>}></Route>
