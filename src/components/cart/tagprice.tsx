...
const TagPrice:React.FC<TagmenuProps> = ({title,price}) => {
    return(
        ...
        <div className=' flex flex-col w-[80%] mx-auto gap-[10px]'>
            <div className='flex flex-row justify-between'>
                ...
                <p className="mx-2 font-bold text-[#EEDBC4] lg:text-[20px]  2xl:text-[30px] xl:text-[25px] md:text-[18px] text-[12px]">{price.toFixed(2)}</p>
            </div>
