...
const SetCardMenu:React.FC<{}> = () => {
    return(
        <div className='m-[30px] flex flex-row flex-wrap xl:gap-[20px] lg:gap-[15px] md:gap-[10px] gap-[5px] xl:w-[65%] 2xl:w-[70%] lg:w-[65%] md:w-[80%] w-[95%] mx-auto justify-center '>
        ...
        <CardMenu name='CHAMOMILE TEA ' image='/public/tea/Chamomile tea.jpg' option={['Size','Temperature','Ice level','Flavor add-on']} price='$25' like='120' ></CardMenu>
