...
const CardMenu: React.FC<datacard> = ({name,image,option,price,like}) => {
    return(
        <div className='xl:w-[231px] xl:h-[290px] md:w-[180px] md:h-[230px] w-[100px] h-[130px]  bg-[url("/component-pic/card-bg.png")] bg-cover bg-center flex flex-col md:p-[10px] p-[4px] rounded-md md:rounded-xl md:gap-[5px] justify-start border-2 md:border-6 border-[#66574E] shadow-lg shadow-black/90'>
            ...
            <div className='items-center justify-center relative mt-auto flex flex-row md:gap-[5px] gap-[2px]'>
                <img src='/public/logo/heart.png' alt='' className="xl:w-[20px] xl:h-auto md:w-[16px] w-[10px] "/>
